                  ...
                  <li key={event.title} className=" bg-gray-800 px-8 py-10">
                    ...
                    {new Date(event.startTime) > new Date() ? (
                      <>
                        <button
                          type="button"
                          class="text-gray-900 bg-gray-100 font-medium rounded-full text-sm mt-4 px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
